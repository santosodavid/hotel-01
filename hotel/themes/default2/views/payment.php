	...
	<table>
		<tr>
			<td>
				...
				</h3> <?php foreach ($payment_methods as $method=>$info):?> <?php
				if($module == $method)
				{
					$selected	= 'checked';
				}
				...
				<p>
					<input type="radio" name="payment_method" <?php echo $selected;?>
...
<?php echo $selected;?>>
	...
	<?php echo $info['form'];?>
	<input type="hidden" name="module" value="<?echo $method; ?>" /> <input
		type="submit" name="submit"
		value="<?php echo lang('submit_payment_method');?>" />
</div>
<?php echo form_close(); ?>
<?php endforeach;?>
