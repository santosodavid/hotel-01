...
<div class="row">
	...
	<div class="span4">
		<h3>
			<?php echo ($ship != $bill)?lang('shipping_information'):lang('shipping_and_billing');?>
		</h3>
	...
	<div class="span4">
		<h3>
			<?php echo lang('billing_information');?>
		</h3>
...
<div class="row">
	<div class="span4">
		<h3>
			<?php echo lang('additional_details');?>
		</h3>
		<?php
		if(!empty($referral)):?>
		<div>
			<strong><?php echo lang('heard_about');?> </strong>
			<?php echo $referral;?>
		</div>
		<?php endif;?>
...
<table class="table table-bordered table-striped"
	...
	<tfoot>
		...
		<tr>
			...
			<td><?php echo format_currency(0-$go_cart['gift_card_discount']); ?>
			</td>
		</tr>
		<?php endif;?>
		<tr>
