...
<div class="row">
	<div class="span6">
		...
		<table class="table">
			...
			<tr style="cursor: pointer">
				<td style="width: 16px;"><label class="radio"><?php echo form_radio('shipping_method', $ship_encoded, set_radio('shipping_method', $ship_encoded, $checked), 'id="s'.$ship_encoded.'"');?>
				</label>
				</td>
				<td onclick="toggle_shipping('s<?php echo $ship_encoded;?>');"><?php echo $key;?>
				</td>
				<td onclick="toggle_shipping('s<?php echo $ship_encoded;?>');"><strong><?php echo $val['str'];?>
				</strong></td>
			</tr>
			<?php endforeach;?>
		</table>
	...
	<div class="span6">
		<h2>
			<?php echo lang('shipping_instructions')?>
		</h2>
...
<input
	class="btn btn-block btn-large btn-primary" type="submit"
