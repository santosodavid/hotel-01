...
<div class="row" style="margin-top: 50px;">
	<div class="span6 offset3">
		...
		<input type="hidden" name="submitted" value="submitted" /> <input
		...
		<fieldset>
			...
			<div class="row">
				<div class="span3">
					<label for="account_firstname"><?php echo lang('account_firstname');?>
					</label>
					<?php echo form_input($first);?>
				</div>

				<div class="span3">
					<label for="account_lastname"><?php echo lang('account_lastname');?>
					</label>
			...
			<div class="row">
				<div class="span7">
					<label class="checkbox"> <input type="checkbox"
						...
						<?php echo set_radio('email_subscribe', '1', TRUE); ?> /> <?php echo lang('account_newsletter_subscribe');?>
					</label>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="span3">
					...
					</label> <input type="password" name="confirm" value=""
						class="span3" />
				</div>
			</div>
		...
		<div style="text-align: center;">
			<a href="<?php echo site_url('secure/login'); ?>"><?php echo lang('go_to_login');?>
			</a>
		</div>
	</div>
</div>
