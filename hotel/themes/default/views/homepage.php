...
<div
	...
	<div class="span12 slideshow">
		...
		<div id="nivoslider-125-caption-0" class="nivo-html-caption">You can
			add captions too&#8230;</div>
	</div>

	<div class="calendar-today"
		style="font: 75% Arial, Helvetica, sans-serif;">
		<div id="calendar"></div>
	</div>
...
#background {
	...
	background: url('<?php echo theme_img(' calendar.png '); ?> ')
...
<div class="row-fluid">
	...
	<div class="span3">
		...
		<?php
		$len = strlen($box->title);
		$firstTitle = substr($box->title, 0,1);
		$secondTitle = substr($box->title, 1);
		echo "<h3><span>$firstTitle</span>$secondTitle</h3>";
