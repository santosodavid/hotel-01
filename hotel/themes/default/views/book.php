		...
		<div class="row">
				...
				<form class="form-horizontal">
					...
					<fieldset>
						...
						<div class="row">
							<div class="span9">
								<br>
								<a href="bookpay" class="btn btn-primary btn-large book-now pull-right">Continue</a>
								<br>
								<br>
							</div>
						</div>
			...
			<div class="span3">
				...
				<p>
					...
					</p><div class="pull-left">Arrival : <i>Thu 10, Jan 2013</i></div><br>
					<div class="pull-left">Departure : <i>Fri 11, January 2013</i></div><br>

					<br>
					Your choosen room is:
					<div class="pull-left"><i>A Luxury Room for 2 adults and 1 child</i></div><br>
					<br><br>
				<p></p>
