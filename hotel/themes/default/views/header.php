                            ...
                            <div class="span5 logo">
                                <a href="index.html">
                                    <div class="span8 logo">
                                        <img alt="Hotel 01" src="hotel/themes/default/assets/img/logo-hotel01.jpg">
                                    </div>
                                </a>
                            </div>		
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="nav-collapse">
                                            <ul class="nav nav-pills">
                                                <li <?php echo ($active == "Home") ? "class='active'" : ""; ?>><a href="index.html">Home</a></li>
                                                <li <?php echo ($active == "Rooms") ? "class='active'" : ""; ?>><a href="rooms.html">Rooms</a></li>
                                                <li <?php echo ($active == "Facilities") ? "class='active'" : ""; ?>><a href="facilities.html">Facilities</a></li>
                                                <li <?php echo ($active == "Gallery") ? "class='active'" : ""; ?>><a href="gallery.html">Gallery</a></li>
                                                <li <?php echo ($active == "Map") ? "class='active'" : ""; ?>><a href="map.html">Map</a></li>
                                                <li <?php echo ($active == "Book") ? "class='active'" : ""; ?>><a href="book-start.html">Book</a></li>
                                            </ul>
                                        </div><!-- /.nav-collapse -->
                                    </div>
                                </div><!-- /navbar -->
