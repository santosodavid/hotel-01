		...
		<div class="row">
			<div class="span12">
				...
				<div class="row">
					...
					<div class="span3 pull-right">
						<p>Extras</p>
						<span class="price" id="extras_price">120.00 GBP</span>
					</div>
				</div>
			...
			<div class="span12">
				...
				<div class="row">
						...
						<form class="form-horizontal">
							...
							<div class="control-group">
								<label for="inputError" class="control-label pay strong">Card
									Number</label>
								<div class="controls">
									<input type="text" class="span3"> <strong>CVV</strong> <input
										type="text" class="span1 cvv2" placeholder="">
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									</select> <select class="span2 year_picker"><option value="0">Year</option>
					...
					<div class="span3 pull-right">
						...
						<span class="price strong" id="total_price">1400.00 GBP</span>
					</div>
