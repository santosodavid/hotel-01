...
<label><?php echo lang('vps_protocol'); ?>: <strong><?php echo $settings['vps_protocol']; ?>
</strong> </label>
...
<div class="controls">
	...
	<label class="checkbox"> <?php echo form_checkbox('card_types[]', $key, isset($settings['card_types'][$key]));?>
		<?php echo $value;?>
	</label>
	<?php endforeach;?>
</div>
