...
class Products extends Admin_Controller {
	...
	function form($id = false, $duplicate = false) {
		...
		if ($id) {
			$data['page_title'] = lang('edit_post_form');
			...
			$data['adults'] = $product->adults;
			$data['kids'] = $product->kids;
		...
		*/
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$save['adults'] = $this->input->post('adults');
			$save['kids'] = $this->input->post('kids');
