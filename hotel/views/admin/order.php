	...
	<div class="span12">
		<div class="btn-group pull-right">
			<a class="btn" title="<?php echo lang('send_email_notification');?>"
				...
				class="icon-envelope"></i> <?php echo lang('send_email_notification');?>
			</a> <a class="btn"
				href="<?php echo site_url('admin/orders/packing_slip/'.$order->id);?>"
				target="_blank"><i class="icon-file"></i> <?php echo lang('packing_slip');?>
			</a>
		</div>
	</div>
</div>
	...
	<div class="span12">
		...
		<fieldset>
			<label><?php echo lang('message_templates');?> </label> <select
				...
				class="span12">
				<option>
					<?php echo lang('select_canned_message');?>
				</option>
...
<div class="row" style="margin-top: 10px;">
	...
	<div class="span4">
		...
		<br />
		<?php echo $order->bill_address1;?>
		<br>
		<?php echo (!empty($order->bill_address2))?$order->bill_address2.'<br/>':'';?>
		<?php echo $order->bill_city.', '.$order->bill_zone.' '.$order->bill_zip;?>
		<br />
		<?php echo $order->bill_country;?>
		<br />

		<?php echo $order->bill_email;?>
		<br />
...
<div class="row" style="margin-top: 20px;">
	...
	<div class="span4">
		<h3>
			<?php echo lang('shipping_details');?>
		</h3>
...
<table class="table table-striped">
	...
	<tbody>
		...
		<tr>
			<td><?php echo $product['name'];?> <?php echo (trim($product['sku']) != '')?'<br/><small>'.lang('sku').': '.$product['sku'].'</small>':'';?>

			</td>
			<td><?php //echo $product['excerpt'];?> <?php
