...
<div class="row">
	...
	<div class="span6">
		<form class="form-inline pull-right">
			<input class="span2" type="text" id="best_sellers_start"
				placeholder="<?php echo lang('from');?>" /> <input type="hidden"
				name="best_sellers_start" id="best_sellers_start_alt" /> <input
				class="span2" type="text" id="best_sellers_end"
				placeholder="<?php echo lang('to');?>" /> <input type="hidden"
				name="best_sellers_end" id="best_sellers_end_alt" /> <input
				class="btn btn-primary" type="button"
				value="<?php echo lang('get_best_sellers');?>"
				onclick="get_best_sellers()" />
		</form>
	</div>
</div>
	...
	<div class="span6">
		<form class="form-inline pull-right">
			<select name="year" id="sales_year">
				...
				<?php endforeach;?>
			</select> <input class="btn btn-primary" type="button"
				value="<?php echo lang('get_monthly_sales');?>"
				onclick="get_monthly_sales()" />
		</form>
	</div>
</div>
