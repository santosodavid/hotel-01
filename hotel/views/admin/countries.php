	...
	<tbody id="countries">
		...
		<tr id="country-<?php echo $location->id;?>">
			...
			<td>
				<div class="btn-group" style="float: right;">
					<a class="btn"
						href="<?php echo site_url($this->config->item('admin_folder').'/locations/country_form/'.$location->id); ?>"><i
						class="icon-pencil"></i> <?php echo lang('edit');?> </a> <a
						class="btn"
						href="<?php echo site_url($this->config->item('admin_folder').'/locations/zones/'.$location->id); ?>"><i
						class="icon-map-marker"></i> <?php echo lang('zones');?> </a> <a
						class="btn btn-danger"
						href="<?php echo site_url($this->config->item('admin_folder').'/locations/delete_country/'.$location->id); ?>"
