...
<fieldset>
	...
	<label for="iso_code_2"><?php echo lang('iso_code_2');?> / <?php echo lang('iso_code_3');?>
	</label>
	<?php
	...
	<label class="checkbox"><?php echo form_checkbox($postcode_required); ?>
		<?php echo lang('require_postcode');?> </label> <label for="tax"><?php echo lang('tax');?>
	</label>
	...
	<label class="checkbox"><?php echo form_checkbox($status); ?> <?php echo lang('enabled');?>
	</label>
