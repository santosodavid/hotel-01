...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Hotel 01<?php echo (isset($page_title)) ? ' :: ' . $page_title : ''; ?></title>
                        ...
                        <div class="nav-collapse">
                            <ul class="nav">
                                ...
                                if ($this->auth->check_access('Admin')) :
                                    ?>
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo lang('common_master') ?> <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="<?php echo $admin_url; ?>categories"><?php echo lang('common_categories') ?></a></li>
                                            <li><a href="<?php echo $admin_url; ?>products"><?php echo lang('common_post') ?></a></li>
                                            <li><a href="<?php echo $admin_url; ?>digital_products"><?php echo lang('common_media') ?></a></li>
                                        </ul>
                                    </li>
